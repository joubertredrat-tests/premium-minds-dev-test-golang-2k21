...
var InvalidStepsError = errors.New("Invalid steps got")
var GameAlreadyStartedError = errors.New("Game already started")
var GameNotFinishedError = errors.New("Game not finished")
...
func (p *PokemonGame) GetPokemonCount() (int, error) {
	if !p.finished {
